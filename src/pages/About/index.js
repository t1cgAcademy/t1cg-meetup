    ...
    <Container fluid={true}>
      <Row>
        <Col size={'md-12'}>
          ...
          Tier 1 Consulting Group is a small, domestic technology services provider, primarily focused on supporting the healthcare IT industry, 
        ...
        <Col size={'md-12'}>
          ...
          <p className="about-text">
          Tier 1 Consulting Group hosts a monthly meet up called Web Development 101. 
          This meetup serves as an educational course for folks who are new to web 
          development or are interested in it, a supplemental resource for students 
          who are currently enrolled, as well as an oppertunity to meet and connect 
          with others on the same journey. This meetup occurs every 2nd wednesday of 
          each month. FREE FOOD and DRINKS are provided! What more could you ask for? 
          RSVP to our next event today!
          </p>
        </Col>
        <Col size={'md-6'}>
