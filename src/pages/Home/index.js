                ...
                <Jumbotron fluid={true}>
                    ...
                    >
                        <h1 className="main-header">
                            Welcome to the T1CG Meetup Site!
                        </h1>
                    </Hero>
                            ...
                            <Col size={'lg-6'}>
                                <Card heading={'General Schedule'}>
                                    <div className="lead border rounded py-3 px-4 mt-3 home-text ">
                                        ...
                                        adipisicing elit. Laudantium est quasi
                                        rerum perferendis explicabo voluptatibus
                                        totam impedit quia. Cumque tenetur ab
                                        atque odio dicta vitae. Lorem ipsum
                                        dolor sit amet consectetur adipisicing
                                        elit. Rerum et quisquam beatae
                                        perferendis deserunt corporis facere,
                                        nemo accusantium vero ipsum, cum animi
                                        quasi nulla nostrum?
                                    </div>
                                </Card>
                            </Col>
